    ...
    <div class="page-header">
      <div class="header-left">
        <div class="page-title-group">
          ...
          <h1 class="page-title">{{ t('inventoryBucket.title') }}</h1>
        </div>
...
async function handleExport() {
  try {
    await ElMessageBox.confirm(
      t('inventoryBucket.messages.exportConfirmMessage'),
      t('inventoryBucket.messages.exportConfirmTitle'),
  ...
  try {
    ...
    a.href = url
    a.download = withExportTimestamp('库存桶列表.csv')
    a.click()
