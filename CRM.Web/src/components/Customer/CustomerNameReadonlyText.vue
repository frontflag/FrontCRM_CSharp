<template>
  <el-tooltip :content="displayText" placement="top" :disabled="tooltipDisabled">
    <span class="customer-name-readonly-text">{{ displayText }}</span>
  </el-tooltip>
</template>
...
const displayText = computed(() =>
  formatCustomerNameReadonly(props.nameZh, props.nameEn, { masked: props.masked })
)
