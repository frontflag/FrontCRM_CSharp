<!-- 三皮肤共用正文（卖方/买方/交付、明细、金额、附加、签字）；样式由父皮肤 :deep 或同根 class 提供 -->
<template>
...
import {
  salesOrderReportFillerRowCount,
  type SalesOrderReportDocumentProps
} from './types'

const props = defineProps<
  Pick<
    SalesOrderReportDocumentProps,
    | 'lines'
    | 'showAmounts'
    | 'totalQty'
    | 'totalIncl'
...
const fillerRowCount = computed(() => salesOrderReportFillerRowCount(props.lines.length))
</script>
