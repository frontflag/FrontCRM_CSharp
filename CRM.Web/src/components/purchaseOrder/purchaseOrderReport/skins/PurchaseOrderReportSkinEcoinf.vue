      ...
      <template #parties>
        <div class="po-doc__addr">
          <section class="po-doc__addr-block">
            <div class="po-doc__section-label">卖方</div>
          ...
          <section class="po-doc__addr-block">
            <div class="po-doc__section-label">买方</div>
            <div class="po-doc__addr-body">
...
import PurchaseOrderReportBody from '../PurchaseOrderReportBody.vue'
import {
...
<style lang="scss">
/* 与 Packing/Invoice/SO Ecoinf 工业极简同源；挂到 idesemi */
.po-doc--ecoinf {
  $eco-accent: #6dc5f6;
  $eco-title: #11161f;
  $eco-ink: #111;
