...
export const AI_SCENARIO_ENTITY_PARSE_RFQ_EXCEL_COLUMN_MAP = 'entity.parse.rfq_excel_column_map'
export const AI_SCENARIO_ENTITY_PARSE_RFQ_EXCEL_BRAND_MAP = 'entity.parse.rfq_excel_brand_map'
