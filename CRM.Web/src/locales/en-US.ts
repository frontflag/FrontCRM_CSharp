...
const enUS = {
  ...
  customsPages: {
    ...
    declarations: {
      ...
      filterWarehouseEntryNo: 'Warehouse entry no.',
      filterPackingCode: 'Packing no.',
      ...
      colWarehouseEntryNo: 'Warehouse entry no.',
      colCreateTime: 'Created at',
      colCreator: 'Created by',
      colActions: 'Actions',
      delete: 'Delete',
      ...
      warehouseEntrySaved: 'Warehouse entry no. saved',
      ...
      opsPanel: {
        ...
        warehouseEntrySave: 'Save',
        warehouseEntryCancel: 'Cancel',
    ...
    fees: {
      ...
      alertNoP0: 'Some lines have no P0; switch Cost (USD) to Manual and enter values, or wait for picking writeback',
      alertRatioStale: 'Line ratio snapshot differs from current system ratio; recalculate to refresh',
      systemRatioHint: 'System {ratio}',
      costUsdModeSystem: 'System',
      costUsdModeManual: 'Manual',
      validateCostUsd: 'Cost (USD) must be a number greater than 0 (up to 6 decimals)',
      validateAgencyRate: 'Agency rate must be a number in 1+rate form (e.g. 1.025000) and ≥ 1',
  ...
  reportParams: {
    ...
    globalHint:
      'Choose the site-wide report style version. V2 applies to purchase-order, packing-list, Commercial Invoice, sales-order report, and warranty prints on the Semicore site only; other sites stay on V1.',
    styleVersionLabel: 'Report style version:',
    styleVersionNote:
      'V2 applies only to Semicore purchase-order, packing-list, Commercial Invoice, sales-order report, and warranty prints. Other sites keep the current layout. Unconfigured sites use V1.',
    saveBtn: 'Save',
    refreshBtn: 'Refresh',
    saveSuccess: 'Saved',
    saveFailed: 'Save failed',
  ...
  riskAlertParams: {
    ...
    hint: 'Thresholds for console risk alerts. Amounts are USD; days use the Shanghai calendar. Enter 0 to turn an alert off.',
    inventoryAmount: 'On-hand inventory value',
    stockAge: 'Stock-item age',
    receivableAmount: 'Open receivables total',
    customerReceivable: 'Per-customer receivables',
    soReceivableAge: 'Sales-order aging days',
    daysUnit: 'days',
    zeroNote: '0 disables that alert. Age defaults to 90 days; amount alerts start off until you set them. Equal to the threshold does not fire; only values above it appear on the console.',
    saveBtn: 'Save',
    refreshBtn: 'Refresh',
    saveSuccess: 'Saved',
    saveFailed: 'Save failed',
    loadFailed: 'Failed to load alert parameters'
  },
  commissionParams: {
    pageTitle: 'Commission parameters',
    pageSubtitle: 'Prepare rate versions in advance and choose which version jobs use. The active version can still be edited; official locked rows stay frozen.',
    navTitle: 'Categories',
    settingsNav: 'Commission settings',
    settingsHint: 'Choose the default sales and purchase rate versions. Create a draft, edit it, then make it active.',
    salesVersion: 'Sales rate version',
    purchaseVersion: 'Purchase rate version',
    editVersion: 'Edit version',
    activeTag: 'Active',
    save: 'Save',
    saveActive: 'Save active versions',
    saveActiveSuccess: 'Active versions saved',
    delayDays: 'Receipt write-off delay days',
    delayDaysUnit: 'days',
    delayDaysHint: 'A line enters the pool only when calculation date minus write-off date is greater than this number. 0 means same-day write-off waits until the next day. Shared by sales and purchase.',
    delayDaysInvalid: 'Delay days must be an integer from 0 to 3650',
    selectBothVersions: 'Select both sales and purchase versions',
    createVersion: 'New version',
    createSalesVersion: 'New sales rate version',
    createPurchaseVersion: 'New purchase rate version',
    createVersionSuccess: 'Version created',
    copyFrom: 'Copy from',
    versionRemark: 'Version note',
    versionRemarkRequired: 'Enter a version note',
    salesNav: 'Salesperson rates',
    purchaseNav: 'Purchaser rates',
    listHint: 'One row per level, up to 10 tiers. Empty tiers are ignored. Pick which version to edit; it does not have to be the active one.',
    colLevel: 'User level',
    colLevelDesc: 'Level description',
    colLadder: 'Tier {n}',
    colThreshold: 'Threshold (USD converted)',
    colPoints: 'Rate points (%)',
    colRemark: 'Remark',
    colActions: 'Actions',
    levelLabel: 'Level {n}',
    edit: 'Edit',
    editTitle: 'Edit {kind} · Level {n}',
    editHint: 'Fill tiers from 1 without gaps. Thresholds must strictly increase and are integers. Use 0 for the first threshold. Points are percents with 1 decimal (5.0 = 5%).',
    ladderIndex: 'Tier',
    ladderN: 'Tier {n}',
    saveSuccess: 'Saved',
    saveFailed: 'Save failed',
    loadFailed: 'Failed to load commission rates'
  },
  commissionResult: {
    estimatedHint: 'Every active salesperson or purchaser is listed. Monthly GP is qualified separately, then summed. Double-click a person to see months, then a month to see lines.',
    personHint: 'Level 3 lists only stock-out lines that participate in that calc month.',
    personDetailSales: 'Sales estimated commission lines',
    personDetailPurchase: 'Purchase estimated commission lines',
    personDetailOfficialSales: 'Sales official commission lines',
    personDetailOfficialPurchase: 'Purchase official commission lines',
    personDetailSalesMonth: 'Sales estimated {month}',
    personDetailPurchaseMonth: 'Purchase estimated {month}',
    personDetailOfficialSalesMonth: 'Sales official {month}',
    personDetailOfficialPurchaseMonth: 'Purchase official {month}',
    monthListSales: 'Sales estimated months',
    monthListPurchase: 'Purchase estimated months',
    monthListOfficialSales: 'Sales official months',
    monthListOfficialPurchase: 'Purchase official months',
    monthKeywordPlaceholder: 'Calc month',
    statsMonthPlaceholder: 'Stats month',
    monthEmpty: 'No calc months',
    monthCount: 'Months',
    monthGp: 'Month GP',
    ...
    entryBase: 'Base',
    entryOther: 'Other',
    backMonths: 'Back to months',
    personKeywordPlaceholder: 'Stock-out / sales / purchase line no.',
    personEmpty: 'No participating lines in this month',
    officialPersonEmpty: 'No official commission stock-out lines',
    personMissing: 'No person specified',
    userAccount: 'User account',
    commissionUser: 'Commission user',
    levelShort: 'Level',
    qualifyGp: 'Qualify GP',
    stockOutDateFull: 'Stock-out date',
    receiptDateFull: 'Receipt write-off date',
    gpShort: 'GP',
    pointsFull: 'Commission points',
    commissionAmount: 'Commission amount',
    receiptWriteOffDone: 'Receipt written off',
    receiptProgress: 'Receipt write-off',
    receiptPending: 'Unverified',
    receiptPartial: 'Partial',
    receiptComplete: 'Written off',
    daysSinceReceipt: 'Days since receipt date',
    inCommission: 'In commission',
    yes: 'Yes',
    no: 'No',
    officialHint: 'On the 2nd of even months the current Base/Other lines are locked. Locked amounts do not change. Double-click a person to see months.',
    keywordPlaceholder: 'Person',
    search: 'Search',
    reset: 'Reset',
    count: '{count} records',
    dateSep: 'to',
    poolDateRange: 'Pool date',
    term: 'Term',
    poolFrom: 'Pool date from',
    poolTo: 'Pool date to',
    backSummary: 'Back to summary',
    salesperson: 'Salesperson',
    purchaser: 'Purchaser',
    userLevel: 'User level',
    lineCount: 'Stock-out items',
    periodGp: 'Monthly GP total',
    estimatedAmount: 'Estimated commission',
    officialAmount: 'Official commission',
    stockOut: 'Stock-out no.',
    stockOutItem: 'Stock-out line no.',
    stockOutDate: 'Stock-out date',
    sellOrder: 'Sales order',
    sellOrderItem: 'Sales line no.',
    purchaseOrder: 'Purchase order',
    purchaseOrderItem: 'Purchase line no.',
    gp: 'Outbound GP',
    points: 'Points',
    receiptDate: 'Receipt date',
    poolDate: 'Pool date',
    empty: 'No commission rows',
    loadFailed: 'Failed to load commission',
    runFailed: 'Action failed',
    recalc: 'Recalculate now',
    recalcConfirm: 'Recalculate all unlocked estimated commission for today and overwrite the current result?',
    recalcDone: 'Recalculated: {sales} sales lines, {purchase} purchase lines',
    lock: 'Lock previous bimonth',
    lockConfirm: 'Lock all current estimated lines as official for this term. Already locked keys are skipped.',
    lockDone: 'Locked term {term}, inserted {n} rows'
  },
  commissionPool: {
    title: 'Commission pool',
    hint: 'Read-only stock-out lines in the commission pool. Sales/purchase status shows whether that side has been locked as official.',
    keywordPlaceholder: 'Stock-out / sales / purchase line no.',
    gp: 'Stock-out GP',
    materialPn: 'PN',
    brand: 'Brand',
    purchasePrice: 'Purchase unit price',
    purchasePriceUsd: 'Purchase unit price (USD)',
    salesPrice: 'Sales unit price',
    salesPriceUsd: 'Sales unit price (USD)',
    qty: 'Outbound qty',
    salesStatus: 'Sales commission status',
    purchaseStatus: 'Purchase status',
    statusOpen: 'Not commissioned',
    statusDone: 'Commissioned',
    statusNa: 'N/A',
    stockOutFrom: 'Stock-out from',
    stockOutTo: 'Stock-out to',
    empty: 'No pool rows',
    loadFailed: 'Failed to load commission pool'
  },
  layout: {
    ...
    menu: {
      ...
      customerQuoteDrafts: 'Customer Quote Drafts',
      ...
      receivableStatements: 'Customer statements',
      ...
      commissionOfficial: 'Official Commission',
      commissionEstimatedSales: 'Sales Estimated Commission',
      commissionEstimatedPurchase: 'Purchase Estimated Commission',
      commissionOfficialSales: 'Sales Official Commission',
      commissionOfficialPurchase: 'Purchase Official Commission',
      ...
      commissionParams: 'Commission parameters',
      riskAlertParams: 'Alert parameters',
  ...
  salesAnalytics: {
    ...
    orderTab: {
      ...
      breakdown: {
        ...
        brandQty: 'Brand transactions (approved)',
  ...
  dashboard: {
    ...
    incentive: {
      ...
      salesRole: 'Sales commission',
      purchaseRole: 'Purchase commission',
      estimated: 'Estimated commission',
      termPlan: 'Term target',
      yearPlan: 'Year target',
      yearActual: 'Year to date',
      progress: 'Progress',
      unset: 'Not set',
      rate: '{pct}% reached',
      rateOver: '999.9%+ reached',
      settings: 'Set targets',
      detail: 'Commission details',
      dialogTitle: 'Set commission targets',
      termField: 'Term target ({period})',
      yearField: 'Year target ({period})',
      hint: 'Amounts are in USD. Enter 0 or clear a field to remove that target. The term follows the commission bimonth window; set it again after the window rolls.',
      save: 'Save',
      saved: 'Saved',
      saveFailed: 'Could not save',
      permRead: 'Incentive targets — view',
      permWrite: 'Incentive targets — edit'
    },
    risk: {
      title: 'Risk alerts',
      immediate: '{n} item(s) need action',
      none: 'No threshold breaches',
      unconfigured: 'Alert thresholds are not set',
      openParams: 'Alert parameters',
      inventoryAmount: 'On-hand inventory over limit',
      stockAge: 'Stock age over limit',
      receivableAmount: 'Receivables over limit',
      customerReceivable: 'Customer receivables over limit',
      soReceivableAge: 'Sales-order aging over limit',
      vsThreshold: 'Now {actual} / limit {threshold}',
      ageDetail: '{count} line(s) over age, longest {days} days',
      customerDetail: '{name} {actual} / limit {threshold}',
      soDetail: '{code} aged {days} days',
      masked: '—',
    ...
    industryNews: {
      ...
      viewHistory: 'History',
      historyTitle: 'Daily industry news',
      historyDates: 'Briefing dates',
      historyEmpty: 'No briefings yet',
      historyMissing: 'No briefing for this day',
      periodCover: '{start}–{end}',
      refreshNow: 'Refresh now',
      refreshing: 'Generating…',
      refreshDone: 'Industry news updated',
      refreshFailed: 'Refresh failed',
      refreshStillRunning: 'Generation is still running. Refresh the page in a minute.',
    ...
    overview: {
      ...
      asOfToday: 'All time to date',
      stockItemCountHint: 'Stock item lines (all time to date)',
      payableItemCountHint: 'Payable lines (all time to date)',
      last30DaysItemHint: 'Line items (last 30 days)',
      scopeUnknown: 'Scope unavailable',
      ...
      customs: 'Customs',
      payment: 'Payments',
      purchaseInvoiceWriteOff: 'Purchase invoice write-offs',
      receipt: 'Receipts',
      receivableWriteOff: 'Receipt write-offs',
      sellInvoiceWriteOff: 'Sales invoice write-offs',
      rfqTrend: 'RFQ trend',
      quoteTrend: 'Quote trend',
      dealTrend: 'Deal trend',
      purchaseTrend: 'Purchase trend',
      stockInTrend: 'Inbound trend',
      stockOutTrend: 'Outbound trend',
      paymentTrend: 'Payment trend',
      receiptTrend: 'Receipt trend',
    ...
    calendar: {
      ...
      newFollow: 'New customer follow-up',
      customer: 'Customer',
      ...
      formRequired: 'Customer, title and start date are required',
      statusPending: 'Pending',
  ...
  systemRole: {
    ...
    deleteSuccess: 'Deleted successfully',
    editTitle: 'Edit Role',
    editSubtitle: 'Maintain the role name, permissions, and assigned accounts.',
    createTitle: 'New Role',
    createSubtitle: 'Enter role details and permissions, then save.',
    navSettings: 'Role settings',
    navUsers: 'Role users',
    settingsHint: 'Maintain role code, name, status, and permissions.',
    ...
    usersTitle: 'Role users',
    usersHint: 'Accounts that currently have this role.',
    usersEmpty: 'No accounts have this role',
    usersCreateHint: 'Save the role first to see assigned accounts.',
    usersLoadFailed: 'Failed to load role users',
    usersCount: '{count} users',
    addUsers: 'Add users',
    addUsersHint: 'Enabled accounts that do not currently have this role. Multiple selection is supported.',
    addUsersSearchPlaceholder: 'Account or real name',
    addUsersSearchEmpty: 'No matching accounts',
    addUsersEmpty: 'No accounts available to add',
    addUsersNeedSelect: 'Select at least one account',
    addUsersConfirm: 'Confirm',
    addUsersSuccess: 'Users added',
    addUsersFailed: 'Failed to add users',
    addUsersLoadFailed: 'Failed to load accounts',
    editAccount: 'Edit account',
    removeRole: 'Remove role',
    removeRoleConfirmTitle: 'Remove role',
    removeRoleConfirmMessage: 'Remove the current role from account "{user}"? The account will no longer have this role.',
  ...
  aiInteraction: {
    ...
    skillPlaceholder: 'Current skill: {name}',
    send: 'Send',
    thinking: 'Answering…',
    feedbackEnded: 'This feedback round has ended. Press Esc, then Space for a new round.',
    askFailed: 'Could not ask',
    routeFailed: 'Could not choose a skill',
    questionTooLong: 'Keep this message within 500 characters',
    handbookNeedsText: 'Training Q&A needs text',
    imageNeedsFeedback: 'Images go with feedback only',
    createParsing: 'Parsing {name}. Please wait...',
    createTitle: 'Create from this text',
    refsTitle: 'Related documents',
  ...
  systemUserLevel: {
    title: 'User level',
    pageSubtitle: 'Maintain level descriptions and assign each employee a level from 1 to 20.',
    navCatalog: 'Level list',
    navUsers: 'User levels',
    catalogTitle: 'Level list',
    catalogHint: 'Levels 1–20 are fixed; only the description is editable.',
    catalogEmpty: 'No level data',
    colDescription: 'Description',
    editDescription: 'Edit description',
    editDescriptionTitle: 'Edit level description',
  ...
  customerQuoteDraftList: {
    ...
    generate: 'Generate customer quote',
    generateEmpty: 'Select drafts first',
    generateDifferentCustomer: 'Selected drafts must belong to the same customer',
    generateDifferentSales: 'Selected drafts must belong to the same sales rep',
    generateSuccess: 'Customer quote created',
    generateFailed: 'Generate failed',
    statusDraft: 'Draft',
    colStatus: 'Status',
    colDraftDate: 'Draft date',
    colCustomer: 'Customer',
    colSales: 'Sales',
    colMpn: 'MPN',
    colBrand: 'Brand',
    ...
    colCustomerMpn: 'Customer MPN',
    colCustomerBrand: 'Customer brand',
    colSourceQuote: 'Source quote no.',
    colQuoteDate: 'Quote date',
    colPurchaser: 'Purchaser',
    colActions: 'Actions',
    delete: 'Delete',
    deleteConfirm: 'Delete this draft? You can add the same purchase quote line again afterward.',
    deleteSuccess: 'Deleted',
    deleteFailed: 'Delete failed',
    loadFailed: 'Load failed'
  },
  customerQuoteList: {
    ...
    count: '{count} total',
    openDrafts: 'Drafts',
    keywordPlaceholder: 'Customer quote code',
    allStatus: 'All statuses',
    statusUnsent: 'Pending',
    statusSent: 'Sent',
    statusVoid: 'Void',
    query: 'Search',
    reset: 'Reset',
    ...
    colCustomer: 'Customer',
    colContact: 'Contact',
    colContactEmail: 'Send email',
    colSales: 'Sales',
    colItemSummary: 'Quote lines',
    colSentAt: 'Sent date',
    colSentByEmail: 'Emailed',
    sentYes: 'Yes',
    sentNo: 'No',
    ...
    loadFailed: 'Load failed',
    delete: 'Delete',
    deleteConfirm: 'Delete this quote? It will disappear from the list. Only pending quotes can be deleted.',
    deleteSuccess: 'Deleted',
    deleteFailed: 'Delete failed',
    markSent: 'Mark as sent',
    markSentConfirm: 'Mark this quote as sent? No email will be sent.',
    markSentSuccess: 'Marked as sent',
    markSentFailed: 'Mark as sent failed'
  },
  customerQuoteEdit: {
    back: 'Back',
    captionPrefix: 'Customer quote',
    ...
    applyProfitFactor: 'Apply send prices',
    colMpn: 'Material MPN',
    colBrand: 'Brand',
    colCustomerMpn: 'Customer MPN',
    colCustomerBrand: 'Customer brand',
    colQty: 'Qty',
    colPurchasePrice: 'Purchase quote',
    colSendPrice: 'Send quote',
    colProfitRate: 'Profit rate',
    lock: 'Lock',
    unlock: 'Unlock',
    colLeadTime: 'Lead time',
    colDateCode: 'Date code',
    colRemark: 'Remark',
    colSourceQuote: 'Source quote',
    colPurchaser: 'Purchaser',
    invalidId: 'Invalid customer quote id',
    loadFailed: 'Load failed',
    saveSuccess: 'Saved',
    saveFailed: 'Save failed',
    applySuccess: 'Send prices updated from profit factor',
    applyFailed: 'Apply failed',
    profitFactorInvalid: 'Profit factor must be greater than 0',
    exportAndSend: 'Export & send',
    unsavedPreviewHint: 'You have unsaved changes. Preview uses saved data. Save first?',
    saveAndPreview: 'Save and continue',
    previewWithoutSave: 'Continue without saving',
  ...
  customerQuoteReport: {
    ...
    emailTitle: 'Send customer quotation',
    emailTip: 'The current quotation preview will be attached as a PDF.',
    contact: 'Contact',
    contactPlaceholder: 'Select a contact to fill email',
    emailTo: 'Recipient email',
    emailToPlaceholder: 'customer@example.com',
    emailToRequired: 'Enter a recipient email',
    emailFrom: 'Sender email',
    emailFromPlaceholder: 'No default sender mailbox',
    emailSubject: 'Subject',
    emailBody: 'Body',
    defaultSubject: 'Customer quotation {code}',
    defaultBody: 'Please find attached customer quotation {code}.',
    missingId: 'Missing customer quote id',
    loadFailed: 'Failed to load report',
    pdfNoDom: 'Report content not found. Try again.',
  ...
  rfqItemList: {
    ...
    dockQuotes: {
      ...
      addCustomerQuoteDraftFailed: 'Failed to add customer quote draft',
  ...
  customerDetail: {
    primaryTabs: {
      ...
      statementNoPermission: 'You do not have permission to view statements',
      portraitNoPermission: 'You do not have permission to view sales analytics',
      newsHidden: 'This account is masked, news is hidden'
    },
    followUp: {
      hint: 'This tab lists every follow-up for this customer, including tasks assigned to colleagues. Completing a task writes a contact-history note.',
      all: 'All',
      includeCancelled: 'Include cancelled',
      newFollow: 'New follow-up',
      empty: 'No follow-up tasks',
      loadFailed: 'Failed to load follow-ups',
      noSelection: 'Select a follow-up',
      save: 'Save',
      saved: 'Saved',
      saveFailed: 'Save failed',
      title: 'Title',
      content: 'Details',
      customerLocked: 'Current customer',
      writtenToHistory: 'Written to contact history on the profile tab',
      formRequired: 'Title and start date are required'
    },
    news: {
      hint: 'Pull a public-intelligence briefing for this customer. Multiple runs per day are allowed.',
      fetchNow: 'Fetch now',
      fetchRunning: 'Fetching…',
      fetchStarted: 'Fetch started. It usually takes 2–3 minutes. The page will update when it finishes.',
      fetchDone: 'Fetch finished. The new briefing is ready.',
  ...
  customerRecycle: {
    ...
    remove: 'Delete',
    removeTitle: 'Confirm delete',
    removeConfirm: 'Remove customer "{name}" from the recycle bin? It cannot be restored to the customer list.',
    removeSuccessTitle: 'Deleted',
    removeSuccessMessage: 'Customer removed from recycle bin',
    removeFailedTitle: 'Delete failed',
    removeFailedMessage: 'Failed to remove customer from recycle bin',
    loadFailedTitle: 'Load Failed',
  ...
  vendorRecycle: {
    ...
    remove: 'Delete',
    removeTitle: 'Confirm delete',
    removeConfirm: 'Remove vendor "{name}" from the recycle bin? It cannot be restored to the vendor list.',
    removeSuccessTitle: 'Deleted',
    removeSuccessMessage: 'Vendor removed from recycle bin',
    removeFailedTitle: 'Delete failed',
    removeFailedMessage: 'Failed to remove vendor from recycle bin',
    loadFailedTitle: 'Load Failed',
  ...
  salesOrderItemList: {
    ...
    opsPanel: {
      ...
      salesOrderStatus: 'Status',
      docsTitle: 'Documents',
      docsNone: '(none uploaded)',
      docsEmptyExpanded: 'No documents uploaded yet',
      docsLoading: 'Loading…',
      docsExpand: 'Expand',
      docsCollapse: 'Collapse',
      docsCannotPreview: 'This file cannot be previewed. Download it?',
      docsCannotPreviewTitle: 'Cannot preview',
      docsDownload: 'Download',
      docsDownloadFailed: 'Download failed',
  ...
  arrivalNoticeList: {
    ...
    filters: {
      ...
      customsBrokerPlaceholder: 'Customs broker',
  ...
  financeReceivableStatement: {
    listTitle: 'Customer statements',
    detailTitle: 'Customer statement',
    columnSettings: 'Column settings',
    back: 'Back',
    backToReceivables: 'Back to receivables',
    previewReport: 'Preview report',
    langZh: 'Chinese',
    langEn: 'English',
    print: 'Print',
    exportPdf: 'Export PDF',
    advanceWriteOff: 'Advance write-off',
    receiptWriteOff: 'Receipt write-off',
    exportOk: 'PDF exported',
    exportFailed: 'PDF export failed',
    loadFailed: 'Failed to load customer statements',
    notFound: 'Statement not found or access denied',
    invalidPeriod: 'Period start cannot be after period end',
    customerSection: 'Customer',
    statementSection: 'Statement',
    ledgerSection: 'Ledger',
    advanceDoc: 'Advance',
    creditFromMaster: 'customer master',
    paymentDaysValue: 'Net {n} days',
    headerBadge: '{customer} · {currency} · {n} lines',
    lineCount: '{n} lines',
    filters: {
      keyword: 'Search customer code / name / sales',
      currency: 'Currency',
      onlyOpen: 'Outstanding only',
      search: 'Search',
      reset: 'Reset',
      dateSep: 'to'
    },
    columns: {
      customerCode: 'Customer code',
      customerName: 'Chinese name',
      customerEnglishName: 'English name',
      currency: 'Currency',
      receivableCount: 'AR lines',
      amountTotal: 'AR total',
      verifiedDone: 'Received',
      verifiedToBe: 'Outstanding',
      latestStockOutDate: 'Latest stock-out',
      salesUser: 'Sales',
      actions: 'Actions'
    },
    actions: {
    ...
    fields: {
      ...
      contact: 'Contact',
      phone: 'Phone',
      paymentDays: 'Payment terms',
      creditLimit: 'Credit limit',
      salesUser: 'Sales',
      periodFrom: 'From',
      periodTo: 'To',
      agingCutoff: 'Aging cutoff',
      currency: 'Currency',
      generatedOn: 'Generated on'
    },
    kpi: {
      opening: 'Opening AR',
      increase: 'Period increase',
    ...
    printZh: {
      ...
      total: '合计',
      note1: '本单仅供对账，不是收款凭证。',
      note2: '如有异议，请在五个工作日内提出。',
      supplierSign: '供方确认（签章）',
      customerSign: '客户确认（签章）'
    },
    printEn: {
      ...
      colIncrease: 'AR increase',
      colReceived: 'Received',
      colBalance: 'Balance',
      total: 'Total',
      note1: 'This statement is for reconciliation only and is not a payment voucher.',
      note2: 'Please raise disputes within five business days.',
      supplierSign: 'Supplier confirmation',
