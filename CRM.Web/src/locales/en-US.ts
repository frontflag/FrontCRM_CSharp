const enUS = {
  ...
  rfqList: {
    ...
    actions: { column: 'Actions', view: 'View', edit: 'Edit', generateQuote: 'Generate Quote' },
    loadFailed: 'Failed to load data',
    generateQuoteSuccess: 'Quote generated'
  },
  quoteList: {
    title: 'Quote List',
    ...
    filters: {
      search: 'Search',
      placeholder: 'Quote code / RFQ code / MPN / customer',
      status: 'Status',
      allStatus: 'All statuses',
      query: 'Search',
      reset: 'Reset'
  ...
  customerList: {
    ...
    level: { B: 'Level B', C: 'Level C', D: 'Level D', Important: 'Important', Normal: 'Normal', Lead: 'Lead' },
    type: { endUser: 'End User', trader: 'Trader', agency: 'Agency' },
    industry: {
  ...
  purchaseOrderItemList: {
    ...
    columns: {
      ...
      brand: 'Brand',
      qty: 'Qty',
      financePaymentStatus: 'Payment status',
      stockInStatus: 'Inbound status',
      cost: 'Unit price',
      lineTotal: 'Line total',
      createTime: 'Created at',
      createUser: 'Created by',
  ...
  financePaymentList: {
    ...
    formVendorId: 'Vendor ID',
    formVendorIdPh: 'Enter vendor ID',
