const zhCN = {
  ...
  rfqList: {
    ...
    actions: { column: '操作', view: '查看', edit: '编辑', generateQuote: '生成报价' },
    loadFailed: '加载数据失败',
    generateQuoteSuccess: '已生成报价单'
  },
  quoteList: {
    title: '报价列表 (Quote)',
    count: '共 {count} 条报价',
  ...
  customerList: {
    ...
    level: { B: 'B级', C: 'C级', D: 'D级', Important: '重要', Normal: '普通', Lead: '潜在' },
    type: { endUser: '终端用户', trader: '贸易商', agency: '代理商' },
    industry: {
      Manufacturing: '制造业',
      Trading: '贸易/零售',
      Technology: '科技/IT',
