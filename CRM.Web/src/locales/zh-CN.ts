...
const zhCN = {
  ...
  customsPages: {
    brokers: {
      ...
      formEmail: '邮箱',
      formAddress: '地址',
      formConsigneeHint: '以下资料印在报关装箱单收货人栏。按装箱单上需印出的文字填写；香港报关行建议维护英文名与英文地址。',
      formRegionType: '服务方向',
      formRemark: '备注',
      formAgencyRate: '代理费率',
      ...
      validateContactRequired: '请填写装箱单收货人联系人',
      validateTelRequired: '请填写装箱单收货人电话',
      validateAddressRequired: '请填写装箱单收货人地址',
      validateEmailInvalid: '邮箱格式无效',
      detailTitle: '报关公司详情',
      statusActive: '启用',
      statusInactive: '停用'
    },
    ...
    declarations: {
      ...
      filterCode: '报关单号',
      filterWarehouseEntryNo: '报关入仓号',
      filterPackingCode: '装箱单号',
      filterSor: '出库通知单号',
      ...
      opsPanel: {
        ...
        warehouseEntrySave: '保存',
        warehouseEntryCancel: '取消',
        clearanceTitle: '海关状态',
        arrivalTitle: '报关到货通知',
        completed: '已完成',
    ...
    fees: {
      ...
      alertNoP0: '存在尚未拣货回写的明细（P0=0）；可切换到采购美金价「手工」并填写后试算，或等待拣货回写',
      alertRatioStale: '行内采购系数快照与系统当前生效系数不一致，重新试算后将更新快照',
      systemRatioHint: '系统当前 {ratio}',
      costUsdModeSystem: '系统',
      costUsdModeManual: '手工',
      validateCostUsd: '采购美金价须为大于 0 的合法数字（最多 6 位小数）',
      validateAgencyRate: '代理费率须为合法数字，格式为 1+费率（如 1.025000），且不能小于 1',
  ...
  reportParams: {
    ...
    globalTitle: '报表全局参数',
    globalHint:
      '设置全站报表样式版本。V2 仅 Semicore 站点的采购订单、装箱单、Commercial Invoice、销售订单报表与质保书换新版式；其他站点仍为 V1。',
    styleVersionLabel: '报表样式版本：',
    styleVersionNote:
      'V2 仅对 Semicore 站点的采购订单、装箱单、Commercial Invoice、销售订单报表与质保书打印生效；其他站点仍用现有样式。未配置时按 V1。',
    saveBtn: '保存',
    refreshBtn: '刷新',
    saveSuccess: '保存成功',
    saveFailed: '保存失败',
  ...
  riskAlertParams: {
    title: '预警参数',
    hint: '设置控制台风险预警的门槛。金额为美金；天数为上海日历日。填 0 表示关闭该项。',
    inventoryAmount: '库存占用资金总额',
    stockAge: '库存明细库龄',
    receivableAmount: '应收款资金总额',
    customerReceivable: '单个客户应收',
    soReceivableAge: '销售订单挂账天数',
    daysUnit: '天',
    zeroNote: '金额或天数填 0 则该项不预警。库龄、挂账默认 90 天，金额默认关闭，需按业务自行设定。相等不预警，只有超过门槛才出现在控制台。',
    saveBtn: '保存',
    refreshBtn: '刷新',
    saveSuccess: '保存成功',
    saveFailed: '保存失败',
  ...
  commissionParams: {
    pageTitle: '提成参数',
    pageSubtitle: '预先配制多个系数版本，指定生效版本供计算使用。生效版仍可改档；正式提成锁定后不再变。',
    navTitle: '参数分类',
    settingsNav: '提成参数',
    settingsHint: '计算预计提成时默认使用这里保存的生效版本。可先新建并编辑草稿版本，再切换为生效。',
    salesNav: '业务员提成系数',
    purchaseNav: '采购员提成系数',
    salesVersion: '业务提成系数版本',
    purchaseVersion: '采购提成系数版本',
    editVersion: '当前编辑版本',
    activeTag: '生效',
    createVersion: '新建版本',
    createSalesVersion: '新建业务提成系数版本',
    createPurchaseVersion: '新建采购提成系数版本',
    copyFrom: '复制自',
    versionRemark: '版本说明',
    versionRemarkRequired: '请填写版本说明',
    save: '保存',
    saveActive: '保存生效版本',
    saveActiveSuccess: '已保存生效版本',
    delayDays: '收款核销延期提成天数',
    delayDaysUnit: '天',
    delayDaysHint: '提成计算日期减去收款核销日期，须大于该天数后才入池。填 0 时核销当天不算，次日才入池。业务员与采购员共用。',
    delayDaysInvalid: '延期天数须为 0～3650 的整数',
    createVersionSuccess: '已新建版本',
    selectBothVersions: '请选择业务与采购的生效版本',
    listHint: '每个等级一行，最多 10 档；未填档不参与计算。改的是上方所选版本，不一定是生效版。',
    colLevel: '用户等级',
    colLevelDesc: '用户等级说明',
    colLadder: '梯度{n}',
  ...
  commissionResult: {
    estimatedHint: '按人汇总：在职业务员/采购员都会列出。金额按各自然月分别达标后相加。双击人员查看各月，再双击月份看出库行。',
    personHint: '第 3 层只列出该计算月已参与提成的出库行。',
    personDetailSales: '业务预计提成明细',
    personDetailPurchase: '采购预计提成明细',
    personDetailOfficialSales: '业务正式提成明细',
    personDetailOfficialPurchase: '采购正式提成明细',
    personDetailSalesMonth: '业务预计提成 {month}',
    personDetailPurchaseMonth: '采购预计提成 {month}',
    personDetailOfficialSalesMonth: '业务正式提成 {month}',
    personDetailOfficialPurchaseMonth: '采购正式提成 {month}',
    monthListSales: '业务预计提成月份',
    monthListPurchase: '采购预计提成月份',
    monthListOfficialSales: '业务正式提成月份',
    monthListOfficialPurchase: '采购正式提成月份',
    monthKeywordPlaceholder: '计算月',
    statsMonthPlaceholder: '统计月份',
    monthEmpty: '暂无计算月',
    monthCount: '参与月数',
    monthGp: '本月 GP',
    calcMonth: '计算月',
    ...
    entryOther: 'Other',
    backMonths: '返回月份',
    personKeywordPlaceholder: '出库/销售/采购明细单号',
    personEmpty: '该月暂无参与提成的出库行',
    officialPersonEmpty: '暂无正式提成出库记录',
    personMissing: '未指定人员',
    userAccount: '用户账号',
    commissionUser: '提成用户',
    levelShort: '等级',
    qualifyGp: '达标GP',
    stockOutDateFull: '出库日期',
    receiptDateFull: '收款核销日期',
    gpShort: 'GP',
    pointsFull: '提成点数',
    commissionAmount: '提成金额',
    receiptWriteOffDone: '是否收款核销',
    receiptProgress: '收款核销',
    receiptPending: '待核销',
    receiptPartial: '部分核销',
    receiptComplete: '核销完成',
    daysSinceReceipt: '收款核销日期距今天数',
    inCommission: '是否参与提成',
    yes: '是',
    no: '否',
    officialHint: '偶数月 2 日锁定当期 Base/Other 行，锁定后金额不再变化。双击人员查看各月。',
    keywordPlaceholder: '人员',
    search: '查询',
    reset: '重置',
    count: '共 {count} 条',
    dateSep: '至',
    ...
    lineCount: '出库条目',
    periodGp: '各月 GP 合计',
    estimatedAmount: '预计提成',
    officialAmount: '正式提成',
    stockOut: '出库单号',
    stockOutItem: '出库明细单号',
    stockOutDate: '出库日',
    sellOrder: '销售单号',
    sellOrderItem: '销售明细单号',
    purchaseOrder: '采购单号',
    purchaseOrderItem: '采购明细单号',
    gp: '出库 GP',
    points: '点数',
    receiptDate: '收款核销日',
    poolDate: '入池日',
    ...
    runFailed: '操作失败',
    recalc: '立即重算',
    recalcConfirm: '按今天重新计算全部未锁定预计提成，并覆盖当前结果？',
    recalcDone: '已重算：业务 {sales} 行，采购 {purchase} 行',
    lock: '锁定上一双月',
    lockConfirm: '将当前预计提成全部锁定为本期正式提成。已锁定的出库行会跳过，不会改已有金额。',
    lockDone: '已锁定账期 {term}，新增 {n} 行'
  },
  commissionPool: {
    title: '提成池',
    hint: '只读查看已完成出库行的入池事实。销售/采购提成状态表示该侧是否已进入正式提成。',
    keywordPlaceholder: '出库/销售/采购明细单号',
    gp: '出库GP',
    materialPn: '物料型号',
    brand: '品牌',
    purchasePrice: '采购单价',
    purchasePriceUsd: '采购单价(折算美金)',
    salesPrice: '销售单价',
    salesPriceUsd: '销售单价(折算美金)',
    qty: '出库数量',
    salesStatus: '销售提成状态',
    purchaseStatus: '采购提成状态',
    statusOpen: '未提成',
    statusDone: '已提成',
    statusNa: '不适用',
    stockOutFrom: '出库日起',
  ...
  layout: {
    ...
    menu: {
      ...
      customerQuotes: '客户报价单',
      customerQuoteDrafts: '客户报价单草稿',
      ...
      commissionPool: '提成池',
      commissionEstimated: '预计提成',
      commissionOfficial: '正式提成',
  ...
  salesAnalytics: {
    ...
    todoReceivableDefinition: {
      chart: '待核销应收款',
      dataSource: '应收款',
      text: '与应收款列表看板「待核销应收款」一致：财务应收台账上待核销余额合计，按原币分档；折算美金按关联销售订单行当时落库的折算单价（历史成交折算，不是打开页面当天的财务汇率）。是对尚未 100% 核销的出库应收的待核销余额；与所选日期无关。'
    },
  ...
  purchaseAnalytics: {
    ...
    quoteTab: {
      datasetTag: '报表',
      hint: '与报价列表看板同实现；口径为报表公司/部门/个人透镜 + 日期范围（报价创建日）+ 排除已删除。',
      refresh: '刷新',
      loadFailed: '加载报价看板失败',
      groupBy: { day: '按日', week: '按周', month: '按月' },
      sections: {
  ...
  dashboard: {
    ...
    incentive: {
      ...
      detail: '提成明细',
      dialogTitle: '设置计划提成',
      termField: '本期计划提成（{period}）',
      yearField: '年度计划提成（{period}）',
      hint: '金额单位为美金。填 0 或清空表示取消该目标。本期跟着提成双月窗口走，窗口切换后需重新设置本期。',
      save: '保存',
      saved: '已保存',
      saveFailed: '保存失败',
      permRead: '激励目标-查看',
    ...
    risk: {
      ...
      immediate: '{n} 项需立即处理',
      none: '暂无超标项',
      unconfigured: '尚未配置预警阈值',
      openParams: '预警参数',
      inventoryAmount: '库存占用资金超标',
      stockAge: '库存库龄超期',
      receivableAmount: '应收款资金超标',
      customerReceivable: '客户应收超标',
      soReceivableAge: '销售订单挂账超期',
      vsThreshold: '当前 {actual} / 阈值 {threshold}',
      ageDetail: '{count} 条超期，最长 {days} 天',
      customerDetail: '{name} {actual} / 阈值 {threshold}',
      soDetail: '{code} 已挂账 {days} 天',
      masked: '—',
      unknownSubject: '未知'
    },
    industryNews: {
      ...
      historyDates: '简报日期',
      historyEmpty: '暂无历史简报',
      historyMissing: '这一天没有简报',
      periodCover: '覆盖 {start}～{end}',
      refreshNow: '立即刷新',
      refreshing: '正在生成…',
      refreshDone: '行业新闻已更新',
      refreshFailed: '刷新失败',
      refreshStillRunning: '生成仍在进行，请稍后刷新页面查看。',
      metaToday: '今日简报 · {n}条',
      metaStale: '非今日简报 · {n}条',
    ...
    overview: {
      ...
      last30Days: '近 30 天',
      asOfToday: '历史至今',
      stockItemCountHint: '库存明细条数（历史至今）',
      payableItemCountHint: '应付明细条数（历史至今）',
      last30DaysItemHint: '明细条数（近 30 天）',
      scopeUnknown: '范围未返回',
      openAnalysis: '打开分析',
      rfq: '需求',
      salesOrder: '订单',
      ...
      customs: '报关',
      payment: '付款',
      purchaseInvoiceWriteOff: '核销进项发票',
      receipt: '收款',
      receivableWriteOff: '核销收款',
      sellInvoiceWriteOff: '核销销项发票',
      rfqTrend: '需求趋势',
      quoteTrend: '报价趋势',
      dealTrend: '成单趋势',
      purchaseTrend: '采购趋势',
  ...
  systemRole: {
    ...
    deleteSuccess: '删除成功',
    editTitle: '编辑角色',
    editSubtitle: '维护角色名称、权限与应用该角色的账号。',
    createTitle: '新增角色',
    createSubtitle: '填写角色信息并勾选权限后保存。',
    navSettings: '角色设置',
    navUsers: '角色用户',
    settingsHint: '维护角色编码、名称、状态与权限。',
    notFound: '角色不存在',
    ...
    usersTitle: '角色用户',
    usersHint: '当前应用该角色的账号。',
    usersEmpty: '暂无账号应用该角色',
    usersCreateHint: '保存角色后可查看应用该角色的账号。',
    usersLoadFailed: '加载角色用户失败',
    usersCount: '{count} 人',
    addUsers: '添加用户',
    addUsersHint: '仅列出未应用当前角色且已启用的账号，可多选。',
    addUsersSearchPlaceholder: '账号或真实姓名',
    addUsersSearchEmpty: '没有匹配的账号',
    addUsersEmpty: '没有可添加的账号',
    addUsersNeedSelect: '请先勾选要添加的账号',
    addUsersConfirm: '确认',
    addUsersSuccess: '已添加用户',
    addUsersFailed: '添加用户失败',
    addUsersLoadFailed: '加载可添加账号失败',
    editAccount: '编辑账号',
    removeRole: '移除角色',
    removeRoleConfirmTitle: '移除角色',
    removeRoleConfirmMessage: '确定从账号「{user}」移除当前角色吗？移除后该账号将不再拥有此角色。',
    removeRoleSuccess: '已移除角色',
  ...
  aiInteraction: {
    ...
    skillPlaceholder: '当前技能是：{name}',
    send: '发送',
    thinking: '正在回答…',
    feedbackEnded: '本轮反馈已结束。按 Esc 退出，再按空格开始新一轮。',
    askFailed: '提问失败',
    routeFailed: '无法判断该用哪项技能',
    questionTooLong: '这一句请控制在 500 字以内',
    handbookNeedsText: '培训问答需要输入文字',
    imageNeedsFeedback: '图片只随反馈与建议发送',
    createParsing: '正在解析{name}，请稍后...',
    createTitle: '用这段文字创建',
    refsTitle: '查看相关文档',
    createCustomer: '创建客户',
    createVendor: '创建供应商',
  ...
  systemUserLevel: {
    title: '用户等级',
    pageSubtitle: '维护等级说明，并为每位员工设置 1～20 的等级。',
    navCatalog: '等级列表',
    navUsers: '用户等级',
    catalogTitle: '等级列表',
    catalogHint: '等级 1～20 固定，仅维护说明。',
    catalogEmpty: '暂无等级数据',
    colDescription: '等级说明',
    editDescription: '编辑说明',
    editDescriptionTitle: '编辑等级说明',
    descriptionSaved: '等级说明已保存',
    colStatus: '是否启用',
    colRealName: '用户名称',
    colUserName: '用户账号',
    colDept: '部门',
  ...
  companyInfo: {
    ...
    smtp: {
      ...
      tabVerified: '已验证用户邮箱',
      sectionHint:
        '配置租户 SMTP/POP 服务器与平台邮箱后缀；仅 SuperAdmin 可查看本页。业务发信使用员工默认平台邮箱；「其他邮箱」只收不发。',
      serverSectionTitle: 'SMTP/POP 服务器',
      platformSuffix: '平台邮箱后缀',
      ...
      enableOutgoing: '启用 SMTP 发信',
      smtpHost: 'SMTP 服务器',
      phSmtpHost: '如 smtp.example.com',
      smtpPort: 'SMTP 端口',
      useSsl: '使用 SSL',
      sslHint: '同时作用于 SMTP 发信与 POP 收信。常见 SMTP 587 / POP 995 开启；具体以邮箱服务商要求为准。',
      useTls: '使用 SSL',
      tlsHint: '同时作用于 SMTP 发信与 POP 收信。常见 SMTP 587 / POP 995 开启；具体以邮箱服务商要求为准。',
      verifiedListTitle: '已验证用户邮箱',
      verifiedListHint: '仅展示验证成功的邮箱；密码默认 ******，点击眼睛查看明文。',
      colAccount: '账号',
      colAddress: '邮箱地址',
      colKind: '类型',
      colDisplayName: '显示名称',
      ...
      kindPlatform: '平台邮箱',
      kindPersonal: '其他邮箱',
      saOnly: '仅 SuperAdmin 可管理公司邮箱配置。',
      emptyVerified: '暂无已验证邮箱',
      showPwd: '显示',
      hidePwd: '隐藏'
    },
    reportInfo: {
  ...
  profilePage: {
    ...
    mailbox: {
      ...
      save: '保存',
      delete: '删除',
      suffixMissing: '管理员尚未配置平台邮箱后缀，无法添加平台邮箱。',
      loadFailed: '加载邮箱失败',
      saved: '已保存',
      saveFailed: '保存失败',
      deleted: '已删除',
      deleteFailed: '删除失败',
      deleteConfirm: '确定删除邮箱「{address}」吗？',
      verifyFailed: '验证失败',
      revealFailed: '获取密码失败',
      phPassword: '请输入邮箱密码或授权码',
  ...
  rfqList: {
    ...
    filters: {
      ...
      allStatus: '全部状态',
      salesUser: '业务员',
      salesUserPlaceholder: '业务员账号',
      createUser: '创建人',
      createUserPlaceholder: '创建人账号',
      tags: '标签',
      createDateFrom: '创建开始',
      createDateTo: '创建结束',
      createDateSep: '至',
  ...
  customerQuoteDraftList: {
    ...
    removeFromBasket: '移除',
    generate: '生成客户报价单',
    generateEmpty: '请先勾选草稿',
    generateDifferentCustomer: '请选择同一家客户的草稿',
    generateDifferentSales: '请选择同一业务员的草稿',
    generateSuccess: '已生成客户报价单',
    generateFailed: '生成失败',
    statusDraft: '草稿',
    colStatus: '状态',
    colDraftDate: '草稿日期',
    ...
    colBrand: '品牌',
    colQty: '数量',
    colPurchasePrice: '采购价',
    colCustomerMpn: '客户料号',
    colCustomerBrand: '客户品牌',
    colSourceQuote: '报价单编号',
    colQuoteDate: '报价日期',
    colPurchaser: '采购员',
    colActions: '操作',
    delete: '删除',
    deleteConfirm: '确定删除该草稿？删除后可再次加入同一采购报价行。',
    deleteSuccess: '已删除',
    deleteFailed: '删除失败',
    loadFailed: '加载失败'
  },
  customerQuoteList: {
    ...
    sentYes: '是',
    sentNo: '否',
    colProfitFactor: '利润系数',
    colCreateTime: '创建日期',
    colCreateBy: '创建人',
    colActions: '操作',
    loadFailed: '加载失败',
    delete: '删除',
    deleteConfirm: '确定删除该报价单？删除后列表不再显示。仅待发送单据可删除。',
    deleteSuccess: '已删除',
    deleteFailed: '删除失败',
    markSent: '设置已发送',
    markSentConfirm: '确定将该报价单设为已发送？不会发送邮件。',
    markSentSuccess: '已设为已发送',
    markSentFailed: '设置失败'
  },
  customerQuoteEdit: {
    back: '返回',
    ...
    contactEmail: '邮箱',
    profitFactor: '利润系数',
    applyProfitFactor: '设置发送报价',
    colMpn: '物料型号',
    colBrand: '品牌',
    colCustomerMpn: '客户物料型号',
    colCustomerBrand: '客户品牌',
    colQty: '数量',
    colPurchasePrice: '采购报价',
    colSendPrice: '发送报价',
    colProfitRate: '利润率',
    lock: '锁定',
    unlock: '解锁',
    ...
    colSourceQuote: '来源报价',
    colPurchaser: '采购员',
    invalidId: '无效的客户报价单 ID',
    loadFailed: '加载失败',
    saveSuccess: '保存成功',
    saveFailed: '保存失败',
    applySuccess: '已按利润系数更新发送价',
    applyFailed: '设置发送报价失败',
    profitFactorInvalid: '利润系数须大于 0',
    exportAndSend: '导出与发送',
    unsavedPreviewHint: '当前有未保存修改。预览使用已保存数据，是否先保存？',
    saveAndPreview: '保存并继续',
    previewWithoutSave: '不保存继续',
    remarkSection: '备注',
  ...
  customerQuoteReport: {
    ...
    emailTitle: '发送客户报价单',
    emailTip: '将当前预览的客户报价单 PDF 作为附件发送。',
    contact: '客户联系人',
    contactPlaceholder: '选择联系人带出邮箱',
    emailTo: '收件人邮箱地址',
    emailToPlaceholder: 'customer@example.com',
    emailToRequired: '请填写收件人邮箱',
    emailFrom: '发件人邮箱地址',
    emailFromPlaceholder: '未配置默认发件邮箱',
    emailSubject: '邮件标题',
    emailBody: '邮件正文',
    defaultSubject: '客户报价单 {code}',
    defaultBody: '请查收附件：客户报价单 {code}。',
    missingId: '缺少客户报价单 ID',
    loadFailed: '加载报表失败',
  ...
  rfqItemList: {
    ...
    dockQuotes: {
      ...
      addCustomerQuoteDraftFailed: '加入客户报价单草稿失败',
      ...
      deletedTitle: '已删报价',
      deletedTitleWithCount: '已删报价 {count} 条',
      deletedBy: '删除人',
      deletedAt: '删除时间',
  ...
  customerDetail: {
    primaryTabs: {
      ...
      news: '新闻动态',
      comingSoon: '内容即将上线',
      statementNoPermission: '暂无查看对账单权限',
      portraitNoPermission: '暂无查看销售分析权限',
      newsHidden: '当前账号已脱敏，不展示新闻动态'
    },
    followUp: {
      hint: '本页显示该客户全部跟进任务，包括同事安排的。完成一条后会记入客户资料里的联系历史。',
      all: '全部',
      includeCancelled: '含已取消',
      newFollow: '新建跟进',
      empty: '暂无跟进任务',
      loadFailed: '加载跟进失败',
      noSelection: '请选择一条跟进',
      ...
      content: '内容',
      customerLocked: '当前客户',
      writtenToHistory: '已记入客户资料中的联系历史',
      formRequired: '请填写标题和开始日期'
    },
    news: {
      hint: '按当前客户抓取公开情报监测简报，同日可多次抓取。',
      fetchNow: '立即抓取',
      fetchRunning: '抓取中',
      fetchStarted: '已开始抓取，估计用时2-3分钟，完成后可在本页查看',
      fetchDone: '抓取完成，可查看新记录',
      fetchFailed: '抓取失败',
      historyDates: '抓取记录',
  ...
  customerEdit: {
    ...
    placeholders: {
      ...
      duns: '请输入邓白氏编码',
      companyEmailSuffix: '只需输入邮箱后缀，如xxx.com，可手工输入或下拉选择',
      salesPerson: '请选择业务员',
      region: '请选择地区',
      companyInfo: '请输入公司介绍',
      remarks: '请输入备注信息'
  ...
  vendorEdit: {
    ...
    fields: {
      ...
      websitePh: 'https://...',
      companyEmailSuffix: '企业邮箱',
      companyEmailSuffixPh: '只需输入邮箱后缀，如xxx.com，可手工输入或下拉选择',
      settlementCurrency: '结算货币',
      currencyPh: '请选择货币',
      paymentMethod: '付款方式',
      paymentPh: '请选择付款方式',
    ...
    levelGuide: {
      ...
      rows: {
        S: {
          name: '安全级',
          source: '原厂、官方授权代理',
          definition: '授权资质齐全；可直接拿原厂资料、COC、Datasheet；货源链路清晰',
          action: '可直接大批量下单；常规 IQC 即可；可做长单、备货'
        },
        A: {
          name: '优选级',
          source: '一级分销、大型正规贸易商',
          definition: '非原厂直供，但上游稳定来自代理 / 原厂渠道、大型工厂渠道；极少炒散货；可提供真实溯源、COC；历史极少品质纠纷',
          action: '正常下单；关键物料要求提供 COC；高价值料做来料检测'
        },
        B: {
          name: '观察级',
          source: '中型市场贸易商',
          definition: '有好货，但同时混杂市场散货；货源链路不完全透明；偶尔出现批号混杂、资料不全；历史有小纠纷但能妥善处理',
          action: '减少大批量备货下单，只做临时调货；高价值、管制物料尽量不从 B 级采；收货必须检验：料号、DC、COC、外观'
        },
        C: {
          name: '风险级',
          source: '小型柜台 / 散货贸易商',
          definition: '货源混杂，上游不可控；甚至历史上出现过翻新、假货、证书造假、扯皮；资质缺失',
          action: '原则不采购；万不得已只能极小批量应急；每批必须第三方检测，不做长期合作'
        },
        D: {
          name: '黑名单',
          source: '贸易市场、各平台',
          definition: '市场公认不诚信、卖假货',
          action: '禁止交易'
        }
      },
      footnote: 'A、B、C 不是固定不变的，后续可以根据交易情况调整等级。'
    },
    contacts: {
      add: '添加联系人',
  ...
  customerRecycle: {
    ...
    remove: '删除',
    removeTitle: '确认删除',
    removeConfirm: '确定从回收站删除客户「{name}」吗？删除后无法再恢复到客户列表。',
    removeSuccessTitle: '已删除',
    removeSuccessMessage: '该客户已从回收站移除',
    removeFailedTitle: '删除失败',
    removeFailedMessage: '从回收站删除失败，请稍后重试',
    loadFailedTitle: '加载失败',
  ...
  vendorRecycle: {
    ...
    remove: '删除',
    removeTitle: '确认删除',
    removeConfirm: '确定从回收站删除供应商「{name}」吗？删除后无法再恢复到供应商列表。',
    removeSuccessTitle: '已删除',
    removeSuccessMessage: '该供应商已从回收站移除',
    removeFailedTitle: '删除失败',
    removeFailedMessage: '从回收站删除失败，请稍后重试',
    loadFailedTitle: '加载失败',
  ...
  stockOutNotifyList: {
    ...
    filters: {
      ...
      salesOrderCodePlaceholder: '销售单号',
      customerSoPlaceholder: '客户订单号',
      customerPnPlaceholder: '客户型号',
      materialModelPlaceholder: '物料型号',
      packingCodePlaceholder: '装箱单号',
      stockOutCodePlaceholder: '出库单号',
      brandPlaceholder: '品牌',
      dateStart: '预计出库起',
      dateEnd: '预计出库止',
      dateTo: '至',
  ...
  packingCreate: {
    ...
    customsBrokerConsigneeIncomplete:
      '所选报关公司尚未维护联系人、电话或地址，请先在「报关公司」中补全装箱单收货人资料。',
  ...
  approvalDesktop: {
    ...
    orderRef: {
      ...
      quoteProfitRateTipTitle: '报价利润率计算过程',
      quoteProfitRateTipAria: '查看报价利润率计算公式',
      quoteProfitRateTipFormula:
        '报价利润率 = 销售单价 ÷ 报价 = {sellUnitPrice} ÷ {quotePrice} = {result}',
      quoteProfitRateTipNoCost: '无报价成本，无法按 销售单价 ÷ 报价 计算。',
  ...
  financeReceivableStatement: {
    ...
    columnSettings: '列设置',
    back: '返回',
    backToReceivables: '返回应收款',
    previewReport: '预览报表',
    langZh: '中文',
    langEn: '英文',
    print: '打印',
    exportPdf: '导出 PDF',
    advanceWriteOff: '预收核销',
    receiptWriteOff: '收款核销',
    exportOk: '已导出 PDF',
    exportFailed: '导出 PDF 失败',
    loadFailed: '加载客户对账单失败',
    notFound: '客户对账单不存在或无权查看',
    invalidPeriod: '对账期间起日不能晚于止日',
    customerSection: '客户资料',
    statementSection: '对账信息',
    ledgerSection: '对账流水',
    advanceDoc: '预收',
    creditFromMaster: '客户档案',
    paymentDaysValue: '账期 {n} 天',
    headerBadge: '{customer} · {currency} · {n} 行',
    lineCount: '{n} 行',
    filters: {
      keyword: '搜索客户编号/名称/业务员',
      currency: '币别',
      onlyOpen: '仅待核销',
      search: '查询',
      reset: '重置',
    ...
    columns: {
      customerCode: '客户编号',
      customerName: '客户中文名',
      customerEnglishName: '客户英文名',
      currency: '币别',
      receivableCount: '应收笔数',
      amountTotal: '应收总额',
      verifiedDone: '已核销',
      verifiedToBe: '待核销',
      latestStockOutDate: '最近出库日',
      salesUser: '业务员',
      actions: '操作'
    },
    actions: {
  ...
  sysAnnouncement: {
    ...
    colActions: '操作',
    body: '正文',
    bodyPh: '支持 Markdown：标题、列表、链接、图片等',
    mdPreview: '预览',
    insertImage: '插入图片',
    imageInserted: '已插入图片',
    imageFailed: '图片上传失败',
    typePlatformNotice: '平台通知',
    ...
    published: '已发布',
    publishFailed: '发布失败',
    publishConfirm: '发布后不可编辑或删除，确认发布？',
    deleted: '已删除',
    deleteFailed: '删除失败',
    deleteConfirm: '确定删除草稿「{title}」？',
    modalTitle: '系统公告',
    forceProgress: '{current} / {total}',
    moreUnread: '还有 {count} 条未读公告，请前往系统公告历史查看。',
    goHistory: '查看系统公告历史',
    prev: '上一篇',
    next: '下一篇',
    close: '关闭',
    drawerTitle: '系统消息',
    tabMessages: '系统消息',
    tabAnnouncements: '系统公告',
    messagesComingSoon: '敬请期待',
    historyEmpty: '暂无系统公告',
    read: '已读',
    unread: '未读'
  },
  sysUserNotice: {
    ...
    colSendTime: '发送时间',
    body: '正文',
    bodyPh: '可只发图片；有文字时最多 4000 字',
    images: '图片',
    imagesHint: '最多 9 张，每张不超过 8MB，支持 jpg / png / webp / gif。可只发图不写正文。',
    imagesExceed: '最多 9 张图片',
    imagesType: '仅支持 jpg、png、webp、gif',
    imagesTooLarge: '单张图片不能超过 8MB',
    imageCount: '{n} 张图片',
    adminEmpty: '暂无系统通知',
    historyEmpty: '暂无系统消息',
    loadFailed: '加载失败',
    sent: '已发送',
    sendFailed: '发送失败',
    needRecipient: '请选择接收人',
    needTitle: '请填写标题',
    needBodyOrImages: '请填写正文或添加图片',
    detailTitle: '系统通知',
    view: '查看',
    dateTodayPrefix: '今日',
    dateYesterdayPrefix: '昨日',
    markAllRead: '设置全部已读',
    markAllReadOk: '已全部标为已读',
    markAllReadFailed: '标记失败',
    adminViewHint: '管理端查看不会把对方标为已读。'
  }
}
