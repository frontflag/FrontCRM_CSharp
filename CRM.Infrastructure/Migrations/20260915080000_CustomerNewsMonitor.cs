...
[Migration("20260915080000_CustomerNewsMonitor")]
public partial class AddCustomerNewsMonitor : Migration
{
...
""");
    ...
    {
        migrationBuilder.Sql(@"
DROP TABLE IF EXISTS public.customer_news_briefing;
DELETE FROM public.ai_invocation_cache WHERE scenario_code = 'customer.news.monitor';
DELETE FROM public.ai_scenario WHERE code = 'customer.news.monitor';
DELETE FROM public.ai_prompt_template WHERE code = 'customer.news.monitor';
");
    }
}
