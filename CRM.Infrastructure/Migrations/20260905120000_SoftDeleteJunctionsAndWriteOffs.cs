...
/// <summary>
/// 收款核销流水、货代收款账户、公司银行、RBAC 关系表改为软删；
/// RBAC 唯一索引改为「未删除」过滤唯一，分配走 diff + 复活。
/// </summary>
[DbContext(typeof(ApplicationDbContext))]
[Migration("20260905120000_SoftDeleteJunctionsAndWriteOffs")]
public partial class SoftDeleteJunctionsAndWriteOffs : Migration
{
