...
-- 21) user_mailbox：个人邮箱（平台/其他），密码对称加密
...
SELECT '20260810120000_AddUserMailbox', '9.0.0'
WHERE NOT EXISTS (
  SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260810120000_AddUserMailbox'
);

-- 22) user_mailbox.is_default_send：默认发信邮箱
...
INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
SELECT '20260810130000_AddUserMailboxDefaultSend', '9.0.0'
WHERE NOT EXISTS (
  SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260810130000_AddUserMailboxDefaultSend'
);
...
INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
SELECT '20260810160000_AddSysAnnouncement', '9.0.0'
WHERE NOT EXISTS (
  SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260810160000_AddSysAnnouncement'
);
-- 24) 我的邮件：user_mailbox IMAP 列 + 邮件落库/同步状态/每日跑批
ALTER TABLE public.user_mailbox
...
INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
SELECT '20260810180000_AddUserMailInbox', '9.0.0'
WHERE NOT EXISTS (
