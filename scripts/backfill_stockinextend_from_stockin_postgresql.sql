-- =============================================================================
-- 为已有 stockin / stockinitem 数据补齐 stockinextend（表已存在且可为空）
...
INSERT INTO public.stockinextend (""StockInId"", last_item_line_seq, ""CreateTime"", ""ModifyTime"")
SELECT
  sin.""StockInId"",
  COALESCE((
...
WHERE NOT EXISTS (
  SELECT 1 FROM public.stockinextend e WHERE e.""StockInId"" = sin.""StockInId"");
