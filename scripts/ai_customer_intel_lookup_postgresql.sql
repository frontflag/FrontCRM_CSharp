-- 增量：customer.intel.lookup 场景 + customer_intel_report 表（已有 AI 模块库执行）
-- DBeaver-safe：Prompt 占位符用 CHR(123)/CHR(125) 拼接，脚本内勿写双花括号字面量
-- 13 章契约：新库执行本脚本后请再执行 ensure_customer_intel_lookup_schema_v2_postgresql.sql
