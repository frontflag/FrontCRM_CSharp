...
CREATE TABLE IF NOT EXISTS public.stock_in_extend (
  ...
  CONSTRAINT ""PK_stock_in_extend"" PRIMARY KEY (""StockInId""),
  CONSTRAINT ""FK_stock_in_extend_stock_in"" FOREIGN KEY (""StockInId"")
...
INSERT INTO public.stock_in_extend (""StockInId"", last_item_line_seq, ""CreateTime"")
SELECT sin.""StockInId"", 0, NOW()
FROM public.stock_in sin
WHERE NOT EXISTS (
  SELECT 1 FROM public.stock_in_extend x WHERE x.""StockInId"" = sin.""StockInId"");
