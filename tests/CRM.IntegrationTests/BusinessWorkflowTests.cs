...
namespace CRM.IntegrationTests
{
    public class BusinessWorkflowTests
    {
        ...
        public async Task OneSalesOrderItem_CanHaveMultipleStockOutRequests_WithinRemainingQty()
        {
            ...
            var pickingTaskItemRepo = Substitute.For<IRepository<PickingTaskItem>>();
            pickingTaskItemRepo.GetAllAsync().Returns(new List<PickingTaskItem>());
            ...
            var stockInItemRepoForStockOut = Substitute.For<IRepository<StockInItem>>();
            ...
            var service = new StockOutService(
                ...
                Substitute.For<ILogOperationAppendService>(),
                Substitute.For<IPackingStatusReconcileService>(),
        ...
        public async Task CreateStockOutRequest_Fails_WhenQuantityExceedsAvailableStock()
        {
            ...
            customerRepoForStockOut.GetAllAsync().Returns(new List<CustomerInfo>());
            var warehouseRepoForStockOut = Substitute.For<IRepository<WarehouseInfo>>();
            var stockItemRepo2 = Substitute.For<IRepository<StockItem>>();
            ...
            var stockInItemRepoForStockOut2 = Substitute.For<IRepository<StockInItem>>();
        ...
        public async Task CompleteOrderExecutionWorkflow_WithMultipleBatches_ShouldSucceed()
        {
            ...
            var stockOutRequestRepo = Substitute.For<IRepository<StockOutRequest>>();
            var pickingTaskRepo = Substitute.For<IRepository<PickingTask>>();
            var pickingTaskItemRepoWf = Substitute.For<IRepository<PickingTaskItem>>();
            pickingTaskItemRepoWf.GetAllAsync().Returns(new List<PickingTaskItem>());
            ...
            var stockItemRepoForWorkflow = Substitute.For<IRepository<StockItem>>();
            ...
            var stockInItemRepoWf = Substitute.For<IRepository<StockInItem>>();
