...
本机制作用于**分配之后**的访问控制，与分配方式（条目轮询 / 品牌轮询 / 采报优先 / 指定采购）相互独立。指定采购细则见 [指定采购-分配方式-设计与实现](./需求/指定采购-分配方式-设计与实现.md)。
...
| [指定采购-分配方式-设计与实现](./需求/指定采购-分配方式-设计与实现.md) | 指定采购分配结果同样受保护时长约束 |
...
| 1.1 | 2026-08-26 | 分配方式列举补指定采购，并链到专题设计 |
