...
| 供应商身份 / 等级 / 行业 | 分 | 同左 | 成单 USD；Mask 时按订单数占比。等级码表 **S/A/B/C**（`vendorinfo.Level` 1～4），见 [供应商等级-设计与实现](../../System/供应商/供应商等级-设计与实现.md) |
...
| 供应商等级码表 | [供应商等级-设计与实现](../../System/供应商/供应商等级-设计与实现.md)（1=S 2=A 3=B 4=C） |
...
| 2026-08-20 | 供应商等级饼图码表改为 S/A/B/C（库内 1～4） |
