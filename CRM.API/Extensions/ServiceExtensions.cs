...
namespace CRM.API.Extensions
{
    public static class ServiceExtensions
    {
        public static IServiceCollection AddApiServices(this IServiceCollection services, IConfiguration configuration, IHostEnvironment hostEnvironment)
        {
            ...
            services.AddScoped<IStockInOpsCheckService, CRM.Infrastructure.StockIns.StockInOpsCheckService>();
            ...
            services.AddScoped<ICustomsDeclarationFlowService, CustomsDeclarationFlowService>();
            services.AddScoped<IStockItemFlowService, StockItemFlowService>();
            services.AddScoped<IStockInFlowService, StockInFlowService>();
            services.AddScoped<IStockOutNotifyFlowService, StockOutNotifyFlowService>();
            services.AddScoped<IStockOutItemFlowService, StockOutItemFlowService>();
            ...
            services.AddScoped<ICustomsAgencyRateInboundCostRefreshService, CustomsAgencyRateInboundCostRefreshService>();
            ...
            services.AddScoped<IReportParamsService, CRM.Infrastructure.ReportParams.ReportParamsService>();
            ...
            services.AddScoped<ISalesOrderIdentityDownstreamSyncService, SalesOrderIdentityDownstreamSyncService>();
            services.AddScoped<ISalesOrderRefreshCompletedGateService, SalesOrderRefreshCompletedGateService>();
            ...
            services.AddHostedService<CRM.API.Services.KbIngestHostedService>();
