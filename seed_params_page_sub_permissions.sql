-- 销售/采购/财务参数：页内子菜单独立权限（幂等）
-- 约定：system.params.{sales|purchase|finance}.{feature}.read|write
...
WHERE "PermissionCode" LIKE 'system.params.sales.%'
   OR "PermissionCode" LIKE 'system.params.purchase.%'
   OR "PermissionCode" LIKE 'system.params.finance.%'
ORDER BY 1;
