...
[Table("customer_quote_draft")]
public class CustomerQuoteDraft : BaseGuidEntity, ISoftDeletable
{
    [Key]
    [StringLength(36)]
    [Column("CustomerQuoteDraftId")]
    ...
    [Column("status")]
    public short Status { get; set; } = CustomerQuoteDraftStatus.Draft;
