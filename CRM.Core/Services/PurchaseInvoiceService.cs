...
namespace CRM.Core.Services
{
    ...
    public class PurchaseInvoiceService : IPurchaseInvoiceService
    {
        ...
        public PurchaseInvoiceService(IRepository<Invoice> repository)
        {
        ...
        /// 创建
        /// </summary>
        public async Task<Invoice> CreateAsync(CreatePurchaseInvoiceRequest request)
        {
        ...
        /// 更新
        /// </summary>
        public async Task<Invoice> UpdateAsync(string id, UpdatePurchaseInvoiceRequest request)
        {
