...
namespace CRM.Core.Services
{
    public partial class CustomerService
    {
            ...
            string? actingUserId)
        {
            ...
            await AppendCustomerFieldChangeLogAsync(customer, "companyEmailSuffix", "企业邮箱", before.CompanyEmailSuffix, after.CompanyEmailSuffix, actingUserId);
