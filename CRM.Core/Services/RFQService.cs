    ...
    public partial class RFQService : IRFQService
    {
        ...
        public async Task<PagedResult<RFQItemListItem>> GetPagedItemsAsync(RFQItemQueryRequest request)
        {
            ...
            var itemReq = new RFQItemQueryRequest
            {
                ...
                StartDate = request.StartDate,
                EndDate = request.EndDate,
                ItemCreateStartUtc = request.ItemCreateStartUtc,
                ItemCreateEndExclusiveUtc = request.ItemCreateEndExclusiveUtc,
                QuoteCreateStartUtc = request.QuoteCreateStartUtc,
                QuoteCreateEndExclusiveUtc = request.QuoteCreateEndExclusiveUtc,
