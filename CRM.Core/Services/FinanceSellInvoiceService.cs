    ...
    public class FinanceSellInvoiceService : IFinanceSellInvoiceService
    {
        ...
        public async Task<FinanceSellInvoice> CreateAsync(CreateFinanceSellInvoiceRequest request, string? actingUserId = null)
        {
            ...
            var invoice = new FinanceSellInvoice
            {
                ...
                MatchDone = 0m,
                MatchToBe = request.InvoiceTotal,
                MatchStatus = 0,
                ReceiveStatus = 0,
                ReceiveDone = 0m,
                ReceiveToBe = 0m,
        ...
        public Task<PagedResult<FinanceSellInvoice>> GetPagedAsync(FinanceSellInvoiceQueryRequest request) =>
            _sellInvoiceListQuery.GetPagedAsync(request);
        ...
        private async Task DeleteCoreAsync(FinanceSellInvoice invoice)
        {
            var id = invoice.Id;
